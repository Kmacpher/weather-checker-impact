...
var _ZipCode = __webpack_require__(28);

var _ZipCode2 = _interopRequireDefault(_ZipCode);

var _Weather = __webpack_require__(55);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    key: 'setZipCode',
    value: function setZipCode(zip) {
      var _this2 = this;

      this.setState({
        zipcode: zip
      });
      _axios2.default.get('http://api.wunderground.com/api/' + key + '/conditions/q/' + zip + '.json').then(function (res) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_ZipCode2.default, { setZipCode: this.setZipCode }),
        this.state.weather ? _react2.default.createElement(_Weather2.default, { weather: this.state.weather }) : _react2.default.createElement(
          'h2',
          null,
          ' You haven\'t entered a zipcode yet!'
        )
      );
    }
  }]);
...
var ZipCode = function ZipCode(props) {

  var clickHandler = function clickHandler(event) {
    var value = event.target.previousSibling.value;
